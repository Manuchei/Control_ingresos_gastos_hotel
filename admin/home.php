...
<h1>Bienvenid@ al <?php echo $_settings->info('name') ?></h1>
<hr>
<div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Presupuesto general</span>
          ...
          <!-- Fijo para pantallas pequeñas únicamente -->
...
<div class="row">
  <div class="col-lg-12">
    <h4>Total en cada categoría</h4>
    <hr>
  </div>
</div>
<div class="col-md-12 d-flex justify-content-center">
  <div class="input-group mb-3 col-md-5">
    <input type="text" class="form-control" id="search" placeholder="Buscar Categoría">
...
<div class="col-md-12">
  <h3 class="text-center" id="noData" style="display:none">No hay información para mostrar.</h3>
</div>
<script>
  function check_cats(){
