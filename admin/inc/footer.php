...
<footer class="main-footer text-sm">
    ...
    <!-- Resuelve el conflicto en jQuery UI tooltip con Bootstrap tooltip -->
    <script>
    ...
    <div class="daterangepicker ltr show-ranges opensright">
      <div class="ranges">
        <ul>
          ...
          <li data-range-key="Last 7 Days">Últimos 7 días</li>
    ...
    <div class="jqvmap-label" style="display: none; left: 1093.83px; top: 394.361px;">Pereira</div>