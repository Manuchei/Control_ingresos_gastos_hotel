    ...
    <div class="card-body">
        ...
        <div id="printable">
            <div>
                ...
                <h3 class="text-center m-0"><b>Reporte de presupuestos</b></h3>
                <hr style="width:15%">
                <p class="text-center m-0">Fechas entre <b><?php echo date("M d, Y",strtotime($date_start)) ?> y <?php echo date("M d, Y",strtotime($date_end)) ?></b></p>
                <hr>
            </div>
